    ...
    <Layout>
      <h1 className="text-4xl uppercase text-center mt-16">
        ...
        <div className={'grid grid-cols-4 gap-10 py-10'}>
            <ClubListing clubName = "BRC Club" clubTagLine = 'Smells like paper, right outta press' clubImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Mercado_de_Col%C3%B3n%2C_Valencia%2C_Espa%C3%B1a%2C_2014-06-29%2C_DD_07.JPG/750px-Mercado_de_Col%C3%B3n%2C_Valencia%2C_Espa%C3%B1a%2C_2014-06-29%2C_DD_07.JPG"/>
