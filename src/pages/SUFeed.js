...
const SUFeed = () => {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col lg:flex-row mt-8 w-full space-y-8 lg:space-y-0 lg:space-x-8 lg:px-8">
        <div className="w-full lg:w-1/4 font-sans overflow-x-hidden px-6 lg:px-0">
        ...
        <div className="w-full lg:w-1/2 font-sans overflow-x-hidden space-y-6 pt-8 lg:pt-0 flex flex-col items-center">
        ...
        <div className="w-full lg:w-1/4 font-sans overflow-x-hidden px-6 lg:px-0 pt-8 lg:pt-0">
